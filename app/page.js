...
const projects = [
  ...
  },
  {
    ...
    description:
      'Прототип для управления связями клиент<->объект. Возможность создавать встречи, вести аналитику с ИИ, выгружать PDF с презентабельной карточкой объекта по нужному шаблону.',
...
const processSteps = [
  {
    ...
    title: 'Обсуждаем',
    description:
      'Простым языком, определяем желание в беседе. Без корпоративных формальностей. Просто рассказываешь, что нужно. Прикидываем цены и сроки.',
  },
  {
    id: 2,
    icon: '◈',
    title: 'Прототип за 1-3 дня',
    description:
      'Быстрый старт, чтобы ты увидел идею в действии и понял, туда ли мы движемся. Заключаем сделку.',
  },
  {
    id: 3,
    icon: '○',
  ...
  return (
    <div style={styles.container}>
      ...
      <header style={styles.hero}>
        ...
        <div style={styles.heroContent} className="hero-content">
          ...
          >
            ...
            >
              Создаю приложения под тебя — в диалоге с тобой, без лишних фич и чужих правил. Только то, что нужно именно тебе.
            </motion.p>
      ...
      <section id="manifest" style={styles.manifestSection} className="manifest-section">
        <div style={styles.manifestContent}>
          ...
          <div style={styles.manifestGrid} className="manifest-grid">
            {[
              { icon: '✦', title: 'Живая разработка', text: 'Программирование через диалог. Возможность выбирать архитектуру и подход к разработке. Гибкость и индивидуальность.' },
              { icon: '◈', title: 'Индивидуальность', text: 'Рыночные решения делают «для всех». Живая разработка дает персонализацию. Твоё приложение должно работать именно под твои задачи.' },
              { icon: '○', title: 'Без мусора', text: 'Никакой рекламы, сбора личных данных, ненужного функционала. Чистый инструмент, который просто работает как ты это представлял.' },
            ].map((item, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 30 }}
      ...
      <section style={styles.statsSection} className="stats-section">
        ...
        >
          «От твоей идеи — к точному воплощению. Диалог между. Минимум лишнего.»
        </motion.div>
      </section>
      ...
      <footer style={styles.footer}>
        <div style={styles.footerContent}>
          ...
          <span>Разработка в диалоге</span>
        </div>
      </footer>
